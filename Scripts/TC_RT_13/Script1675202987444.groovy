...
WebUI.verifyElementText(findTestObject('Object Repository/Page_abcd/input__sub-side-freeword-text'), '')
...
text = WebUI.getAttribute(findTestObject('Object Repository/Page_abcd/input'), 'value')

WebUI.verifyMatch(text, 'abcd', false)
