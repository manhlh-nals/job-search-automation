...
WebUI.rightClick(findTestObject('Object Repository/Page_/input__sub-side-freeword-text'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_/form_OK2431OK'), 0)
